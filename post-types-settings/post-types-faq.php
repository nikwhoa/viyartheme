...
function questions_init() {
    $labels = array(
        'name'                  => _x( 'Вопросы', 'Post type general name', 'recipe' ),
        'singular_name'         => _x( 'Вопросы', 'Post type singular name', 'recipe' ),
        'menu_name'             => _x( 'Вопросы', 'Admin Menu text', 'recipe' ),
        'name_admin_bar'        => _x( 'Вопросы', 'Add New on Toolbar', 'recipe' ),
