...
const projectURL = 'http://localhost:82/viyar-pro-bussines/';
...
const translationFile = 'uk.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'viyartheme';

// Where can users report bugs.
const bugReport = 'https://google.com';

// Last translator Email ID.
const lastTranslator = 'Nikita <norenkonikita@email.com>';

// Team's Email ID.
const team = 'Nikita <norenkonikita@email.com>';

// Browsers you care about for auto-prefixing. Browserlist https://github.com/ai/browserslist
// The following list is set as per WordPress requirements. Though; Feel free to change.
const BROWSERS_LIST = ['last 5 version', '> 1%'];
